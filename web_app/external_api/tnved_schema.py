...
HS_SCHEMA: dict[str, Any] = {
    ...
    "properties": {
        ...
        "evidence_urls": {
            "type": "array",
            "items": {"type": "string"},
            "description": "Ссылки на первоисточники (ЕАЭС/РФ классификаторы, примечания, каталоги производителя и т.п.)",
        },
        "notes": {"type": "string"},
    },
...
3) В "explanations" дай РОВНО 5 логичных, коротких строк — почему выбран код.
...
- Не добавляй в текст метки ссылок типа '[1]', '[2]', и т.д.
